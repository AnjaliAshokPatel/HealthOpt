...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String KEY_GENDER = "gender_name";
    ...
    public static final String CREATE_TABLE="CREATE TABLE " + TABLE_REGISTER + "("
            + KEY_ID + " INTEGER PRIMARY KEY," + KEY_FIRST_NAME + " TEXT,"+KEY_GENDER + " TEXT,"+KEY_EMAIL_ID+ " TEXT,"
    ...
    // code to add the new register
    {
        ...
        values.put(KEY_FIRST_NAME,registerdata.getName()); // register first Name
        values.put(KEY_GENDER, registerdata. getGenderName() ); // register last name
